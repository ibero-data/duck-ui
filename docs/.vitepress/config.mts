...
export default defineConfig({
  title: "Duck-UI",
  description:
    "Modern web interface for DuckDB wasm. Run SQL queries directly in your browser.",
  base: "/",
  ...
  head: [
    ...
    [
      ...
      {
        defer: "",
        "data-site": "site_6cac6a4159ce48a5",
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Changelog",
            link: "https://github.com/ibero-data/duck-ui/releases",
          },
    ...
    footer: {
      message:
        'Released under the Apache 2.0 License. | <a href="https://iberodata.es" target="_blank">Ibero Data</a> · <a href="https://ch-ui.com" target="_blank">CH-UI</a> · <a href="https://yaat.io" target="_blank">YAAT</a>',
